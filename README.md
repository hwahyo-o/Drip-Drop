...
Drip Drop (드립 드롭)은 로스터리 카페 전용 지도 웹앱(웹 사이트 페이지)입니다. 사용자는 현재 위치 주변의 로스터리 카페를 지도와 리스트로 탐색하고, 원두 구매 가능 여부, 필터/브루잉/드립 커피 제공 여부, 메뉴, 운영 시간, 리뷰를 확인할 수 있습니다.
